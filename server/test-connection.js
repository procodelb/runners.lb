...
// Prefer .env; fallback to inline for demonstration. Replace password locally.
require('dotenv').config();
process.env.USE_SQLITE = process.env.USE_SQLITE || 'false';
process.env.DATABASE_URL = process.env.DATABASE_URL || 'postgresql://neondb_owner:REPLACE_WITH_PASSWORD@ep-odd-breeze-adojmdlg-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require';
process.env.PG_SSL = process.env.PG_SSL || 'true';
